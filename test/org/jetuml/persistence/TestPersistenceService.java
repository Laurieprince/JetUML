...
public class TestPersistenceService
{
	...
	{
		final Diagram diagram = (Diagram)PersistenceService.read(PATH_TEST_FILES.resolve(pFileName).toFile()).object();
		...
		Diagram diagram2 = (Diagram)PersistenceService.read(temporaryFile).object();
